...
class App extends Component {
  ...
  handleKycWhitelisting = async () => {
    await this.kycContractInstance.methods.setKycCompleted(this.state.kycAddress).send({
    ...
    return (
      <div className="App">
        ...
        <div>
          ...
          <button type="submit" onClick={this.handleKycWhitelisting}>Add to whitelist</button>
        </div>
        <h2>Buy Tokens</h2>
